...
public struct YPConfigVideo {
    ...
    /// Defines if the user does not enter the video trim stage, it will be trimmed automatically to the maximum value of trimmerMaxDuration
    /// This case occurs when the user is enabled to pick more than one /video the trimmer becomes optional.
